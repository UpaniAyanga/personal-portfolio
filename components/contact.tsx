  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      value: "upanilokusuriya@gmail.com",
      link: "mailto:upanilokusuriya@gmail.com",
    },
    {
              ...
              <div className="lg:col-span-2">
                <Card>
                  <CardContent className="p-6">
                    <form action="https://formspree.io/f/meejqooq" method="POST" className="space-y-6">
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="flex gap-4">
                      <Button variant="outline" size="icon" asChild>
                        <a href="https://github.com/UpaniAyanga" target="_blank" rel="noopener noreferrer">
                          <svg
                      ...
                      <Button variant="outline" size="icon" asChild>
                        <a href="https://www.linkedin.com/in/upani-l/" target="_blank" rel="noopener noreferrer">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                      ...
                      <Button variant="outline" size="icon" asChild>
                        <a href="mailto:upanilokusuriya@gmail.com">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
